...
TABLE(MATCH) = {
	ENUM(KDBUS_CMD_MATCH_BLOOM),
	ENUM(KDBUS_CMD_MATCH_SRC_NAME),
	ENUM(KDBUS_CMD_MATCH_NAME_ADD),
	ENUM(KDBUS_CMD_MATCH_NAME_REMOVE),
	ENUM(KDBUS_CMD_MATCH_NAME_CHANGE),
	ENUM(KDBUS_CMD_MATCH_ID_ADD),
	ENUM(KDBUS_CMD_MATCH_ID_REMOVE),
	ENUM(KDBUS_CMD_MATCH_ID_CHANGE),
};
LOOKUP(MATCH);

TABLE(PAYLOAD) = {
	ENUM(KDBUS_PAYLOAD_NONE),
